...
namespace BlackCat\Database\Packages\AuditChain\Mapper;

use BlackCat\Database\Packages\AuditChain\Dto\AuditChainDto;
use BlackCat\Database\Packages\AuditChain\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO AuditChainDto:
 ...
 */
final class AuditChainDtoMapper
{
    /** @var array<string,string> Column -> DTO property */
    private const COL_TO_PROP = [ 'id' => 'id', 'audit_id' => 'auditId', 'chain_name' => 'chainName', 'prev_hash' => 'prevHash', 'hash' => 'hash', 'created_at' => 'createdAt' ];

    /** @var string[] */
    private const BOOL_COLS   = [];
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'audit_id' ];
    /** @var string[] */
    ...
    /** @var string[] */
    private const BIN_COLS    = [ 'prev_hash', 'hash' ];
     ...
     * @return AuditChainDto
     */
    public static function fromRow(array $row): AuditChainDto
    {
        /** @var AuditChainDto */
    ...
    public static function fromRowOrNull(?array $row): ?AuditChainDto
    {
     ...
     *
     * @param AuditChainDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(AuditChainDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(AuditChainDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(AuditChainDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,AuditChainDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,AuditChainDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(AuditChainDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,AuditChainDto>
     */
