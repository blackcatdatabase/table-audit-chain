...
final class Criteria extends BaseCriteria
{
    ...
    {
        return [ 'id', 'audit_id', 'chain_name', 'prev_hash', 'hash', 'created_at' ];
    }
    ...
    {
        return [ 'id', 'audit_id', 'chain_name', 'created_at' ];
    }
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\AuditChain\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\AuditChain\Definitions::softDeleteColumn();
