...
final class AuditChainModule implements ModuleInterface
{
    public function name(): string { return 'table-audit_chain'; }
    public function table(): string { return 'audit_chain'; }
    public function version(): string { return '1.0.0'; }

    /** @return string[] */
    public function dialects(): array { return [ 'mysql', 'postgres' ]; }
    /** @return string[] */
    public function dependencies(): array { return [ 'table-audit_log' ]; }

    public static function contractView(): string { return 'vw_audit_chain'; }
...
SQL;
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [ 'idx_audit_chain_name_time' ],
            'foreignKeys' => [ 'fk_audit_chain_audit' ],
        ];
    }
}
