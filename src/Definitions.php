...
final class Definitions {
    // --- core metadata ---
    public static function table(): string { return 'audit_chain'; }
    public static function contractView(): string { return 'vw_audit_chain'; }
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'audit_id', 'chain_name', 'prev_hash', 'hash', 'created_at' ]; }
    ...
    public static function uniqueKeys(): array { return [ [ 'audit_id' ], [ 'id' ] ]; }
    ...
    public static function intColumns(): array { return [ 'id', 'audit_id' ]; }
