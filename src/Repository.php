...
use BlackCat\Database\Packages\AuditChain\Repository\AuditChainRepository;
...
final class Repository
{
    ...
    {
        $this->repo = new AuditChainRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\AuditChain\Dto\AuditChainDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\AuditChain\Dto\AuditChainDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\AuditChain\Dto\AuditChainDto|null
    {
