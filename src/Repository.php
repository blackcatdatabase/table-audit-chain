...
namespace BlackCat\Database\Packages\AuditChain;
...
use BlackCat\Database\Packages\AuditChain\Repository\AuditChainRepository as GeneratedRepository;
...
{
  private AuditChainRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof AuditChainRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected AuditChainRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\AuditChain\Dto\AuditChainDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\AuditChain\Dto\AuditChainDto|null { return $this->repo->getById($id, $asDto); }
