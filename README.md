...
> Schema package for table **audit_chain** (repo: `audit-chain`).
...
| id | BIGINT | — | AS | PK |
| audit_id | BIGINT | NO | — |  |
| chain_name | VARCHAR(100) | NO | 'default' |  |
| prev_hash | BYTEA | YES | — |  |
| hash | BYTEA | NO | — |  |
| created_at | TIMESTAMPTZ(6) | NO | CURRENT_TIMESTAMP(6) |  |

## Relationships
- FK → **audit_log** via (audit_id) (ON DELETE CASCADE).
...
erDiagram
  ...
  AUDIT_CHAIN }o--|| AUDIT_LOG : "audit_id"
```
