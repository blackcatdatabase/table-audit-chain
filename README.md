...
| Pkg folder | [packages\audit-chain](https://github.com/blackcatacademy/blackcat-database/blob/main/packages/audit-chain) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package audit-chain -Apply
