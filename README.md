...
- Pkg folder: [packages\audit-chain](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\audit-chain)
...
graph LR
  ...
  audit_chain["audit_chain"]:::center
  audit_chain -->|FK| audit_log["audit_log"]:::link
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package audit-chain -Apply
